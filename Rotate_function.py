...
def rotate_box_dot(frame,x_cen, y_cen, width, height, theta):
    ...
    return [frame,rotated_x1,rotated_y1, rotated_x2,rotated_y2, rotated_x3,rotated_y3, rotated_x4,rotated_y4]